...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if(levelingData) {
            ...
            userStatsEmbed.addFields({ name: '🗓️ Data inizio conteggio', value: new Date(levelingData.StartDate).toLocaleDateString('it-IT', { day: 'numeric', month: 'long', year: 'numeric', hour: 'numeric', minute: 'numeric' }) })
