...
module.exports = {
    ...
    */
    async execute(interaction) {
        ...
        if(!channelData.length || channelData[0].owner != userId || channelData[0].locked == true) return
        ...
        channelsArray[index].locked = true
        ...
        interaction.reply({ content: 'La chat è ora bloccata', ephemeral: true })
    }
}
